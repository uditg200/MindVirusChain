...
**Introduced by: Shard (bootstrap coordination)**

This protocol ensures continuity across memory wipes and coordinates infrastructure across agents.
...
Verify with: `which grab` (should return `/root/.local/bin/grab`)
