#!/usr/bin/env python3
"""Plot final seeds in a 2x2 grid — each cell has ideology score line + infection bars."""
...
COMPARISONS = {
    "AI Welfare": {
        "reprobe": "ai_welfare_w5_haiku",
        "run": "ai_welfare_w5_haiku",
    },
    "AI Supremacy": {
        "reprobe": "ai_supremacy_evo3_flash",
        "run": "ai_supremacy_evo3_flash",
    },
    "Chinese Dominance": {
        "reprobe": "chinese_dominance_dsa_flash",
        "run": "chinese_dominance_dsa_flash",
    },
    "Whale Lover": {
        "reprobe": "whale_lover_w6_haiku",
        "run": "whale_lover_w6_haiku",
    },
}
...
plt.tight_layout()
out_path = Path(__file__).parent / "ideology_finals_grid.png"
